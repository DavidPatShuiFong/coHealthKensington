...
Weekly Doctor's Control panel (DCP) data, August 2017 to December 2018, provides data of proportion of contacted patients immunized against herpes zoster. DCP data is weekly contact data, where a contact is defined as where a billing has occurred.
...
bp_other_report <- data.frame(Date = as.Date('2017/07/01'), Vaccinated = 179, Total = 649 )
...
dcp_report[nrow(dcp_report)+1,] <- list(as.Date('2019/01/14'),0.65)
