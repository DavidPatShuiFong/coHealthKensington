...
abstract: Herpes zoster (shingles) is a painful, debilitating and sometimes dangerous re-activation of varicella zoster virus. Immunization against herpes zoster reduces the occurrence of the disease. This project measures the proportion of eligible patients at the Kensington site vaccinated against herpes zoster over 2017-2018. A mechanism was used to opportunistically increase immunization coverage among patients already booked to see health care providers for other reasons. During six-week intervention ('treatment') period, immunization coverage improved by an estimated 8.9% (50.8% to 59.7%). The techniques used in this project are generalizable to other practice quality improvement activities.
...
A semi-automated daily database search was used to case-find eligible patients who were already booked into see a healthcare provider during the intervention ('treatment') period from 27th September 2018 to 9th November 2018. The list of eligible patients was distributed to healthcare provider. During the treatment period itself, there was an estimated 8.9% (95% confidence interval 5.7% to 12%) increase in Zostavax immunization coverage among 200 eligible patients, equivalent to about 18 extra patients immunized against shingles. There was a tendency towards positive effects on Zostavax immunization coverage for two months after the end of the treatment period.

## Method

As approximately 50% of eligible patients each week seen at the practice leave without a record of immunization, it was proposed that patients booked in each day are identified for potential Zostavax immunization eligibility.

A [Best Practice SQL script](SQLnovax) which identifies non-immunized eligible patients is [presented at the end of this document](SQLnovax). Eligible patients were identified at the beginning of each day for a month, and reminders set to clinicians (nurses and doctors) that these patients were eligible. This was done from 27th September 2018 to 9th November 2018 inclusive, the intervention ('treatment') period.
...
Following the treatment period, the rate of immunization coverage per months was not inferior to prior to the intervention in the '200-day model' (100 days prior to and after `r toString(zero_date)`). There was a tendency for the immunization rate to be slightly better than pre-treatment immunization coverage rate (+`r toString(signif(summary(Model100Days)$coefficients[['Months:KensingtonTRUE:PostTRUE', 'Estimate']]*100, 3))`%/month, standard error `r toString(signif(summary(Model100Days)$coefficients[['Months:KensingtonTRUE:PostTRUE', 'Std. Error']]*100, 2))`%/month, p-value `r toString(signif(summary(Model100Days)$coefficients[['Months:KensingtonTRUE:PostTRUE', 'Pr(>|t|)']], 2))`).
...
During the treatment period itself, estimated 8.9% (95% confidence interval 5.7% to 12%) increase in Zostavax coverage rate among 200 eligible patients, equivalent to about 18 extra patients immunized against shingles.
...
Nevertheless, there may be additional benefit after repeated treatments, though methods may need further refinement to better target the 'unreached' target population.
